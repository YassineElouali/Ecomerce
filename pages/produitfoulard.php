...
<head>
    ...
    <?php require_once "includes/categories-navbar.php"; ?>
</head>
<body>
<div class="global-wrapper clearfix" id="global-wrapper">
    ...
    <div class="product-page-area">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img class="full-width" src="img/500x500.png" alt="Image Alternative text" title="Image Title" />
                </div>
                <div class="col-md-6">
                    ...
                    <h1>Beats by Dre Solo HD On-Ear Headphones with Built-in Mic</h1>
                    <p class="product-page-price">$89.99</p>
                    <p class="text-muted text-sm">Free Shipping</p>
                    <p class="product-page-desc-lg">Solo HD High-performance with advanced driver design that allows you to enjoy every studio nuance of your favorite music. Deeper bass, bolder midrange, and cleaner, undistorted highs.</p>
